...
class Config:
    def __init__(self):
        ...
        self.simple_label_file_A= '/baie/nfs-cluster-1/mundus/njabeen332/Solar_Test/UAD/labels/my_datasimple_label_TIFF_284-fixed_aug.txt'
        self.simple_label_file_B= '/baie/nfs-cluster-1/mundus/njabeen332/Solar_Test/UAD/labels/my_datasimple_label_TIFF_171-fixed_aug.txt'
