...
class Config:
    def __init__(self):
        ...
        self.simple_label_file_A= '/baie/nfs-cluster-1/mundus/njabeen332/Solar_GPU/UAD/labels/my_datasimple_label_TIFF_195-fixed_aug.txt'
        self.simple_label_file_B= '/baie/nfs-cluster-1/mundus/njabeen332/Solar_GPU/UAD/labels/my_datasimple_label_TIFF_304-fixed_aug.txt'
